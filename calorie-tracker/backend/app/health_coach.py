        ...
        compact_days.append(
            {
                ...
                "sleep_seconds": oura.get("total_sleep_seconds"),
                "hrv_ms": oura.get("average_hrv_ms"),
                "stress_seconds": oura.get("stress_high_seconds"),
                "recovery_seconds": oura.get("recovery_high_seconds"),
                "spo2_percent": oura.get("spo2_average_percent"),
                "resilience": oura.get("resilience_level"),
                "rest_mode": oura.get("rest_mode"),
                "bedtime_recommendation": oura.get("sleep_time_recommendation"),
